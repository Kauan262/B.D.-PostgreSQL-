...
-- Criando tabela "tb_discuplina_curso"
-- Restrições:
...
cod_curso			INTEGER,
CONSTRAINT pk_tb_dc_cod_disc_cod_curso PRIMARY KEY(cod_disciplina, cod_curso),
...
-- Criando tabela "tb_pre_requisito"
-- Restrições:
...
-- Realizando uma carga n a tb_curso
...
INSERT INTO tb_disciplina (cod_disciplina, cod_depto, nm_disciplina, credito) VALUES
